...
python "$NANOPB_GEN_DIR"/nanopb_generator.py lib/VirtualDrone/src/VDrone/nanopb/controller.proto
...
protoc --proto_path="$NANOPB_GEN_DIR" --proto_path="$NANOPB_PROTO_DIR" --proto_path="$PROTO_DIR" --python_out="$PROTO_DIR" "$PROTO_DIR/controller.proto"
